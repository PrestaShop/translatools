...
class TranslaTools extends Module
{
	...
	'es-CO' => array('crowdin_code' => 'es-CO', 'prestashop_code' => 'cb'), 'cs-CZ' => array('crowdin_code' => 'cs', 'prestashop_code' => 'cs'), 'da-DK' => array('crowdin_code' => 'da', 'prestashop_code' => 'da'),
	'de-DE' => array('crowdin_code' => 'de', 'prestashop_code' => 'de'), 'el-GR' => array('crowdin_code' => 'el', 'prestashop_code' => 'el'), 'en-US' => array('crowdin_code' => 'en', 'prestashop_code' => 'en'),
	'es-ES' => array('crowdin_code' => 'es-ES', 'prestashop_code' => 'es'), 'et-EE' => array('crowdin_code' => 'et', 'prestashop_code' => 'et'), 'eu-ES' => array('crowdin_code' => 'eu', 'prestashop_code' => 'eu'),
	'fa-IR' => array('crowdin_code' => 'fa', 'prestashop_code' => 'fa'), 'fi-FI' => array('crowdin_code' => 'fi', 'prestashop_code' => 'fi'), 'fo-FO' => array('crowdin_code' => 'fo', 'prestashop_code' => 'fo'),
	'fr-FR' => array('crowdin_code' => 'fr', 'prestashop_code' => 'fr'), 'ga-IE' => array('crowdin_code' => 'ga-IE', 'prestashop_code' => 'ga'), 'en-GB' => array('crowdin_code' => 'en-GB', 'prestashop_code' => 'gb'),
	'gl-ES' => array('crowdin_code' => 'gl', 'prestashop_code' => 'gl'), 'he-IL' => array('crowdin_code' => 'he', 'prestashop_code' => 'he'), 'hi-IN' => array('crowdin_code' => 'hi', 'prestashop_code' => 'hi'),
	'hr-HR' => array('crowdin_code' => 'hr', 'prestashop_code' => 'hr'), 'hu-HU' => array('crowdin_code' => 'hu', 'prestashop_code' => 'hu'), 'hy-AM' => array('crowdin_code' => 'hy-AM', 'prestashop_code' => 'hy'),
	'id-ID' => array('crowdin_code' => 'id', 'prestashop_code' => 'id'), 'it-IT' => array('crowdin_code' => 'it', 'prestashop_code' => 'it'), 'ja-JP' => array('crowdin_code' => 'ja', 'prestashop_code' => 'ja'),
	'ka-GE' => array('crowdin_code' => 'ka', 'prestashop_code' => 'ka'), 'ko-KR' => array('crowdin_code' => 'ko', 'prestashop_code' => 'ko'), 'lo-LA' => array('crowdin_code' => 'lo', 'prestashop_code' => 'lo'),
	'lt-LT' => array('crowdin_code' => 'lt', 'prestashop_code' => 'lt'), 'lv-LV' => array('crowdin_code' => 'lv', 'prestashop_code' => 'lv'), 'mk-MK' => array('crowdin_code' => 'mk', 'prestashop_code' => 'mk'),
	'ml-IN' => array('crowdin_code' => 'ml-IN', 'prestashop_code' => 'ml'), 'ms-MY' => array('crowdin_code' => 'ms', 'prestashop_code' => 'ms'), 'es-MX' => array('crowdin_code' => 'es-MX', 'prestashop_code' => 'mx'),
	'nl-NL' => array('crowdin_code' => 'nl', 'prestashop_code' => 'nl'), 'no-NO' => array('crowdin_code' => 'no', 'prestashop_code' => 'no'), 'pl-PL' => array('crowdin_code' => 'pl', 'prestashop_code' => 'pl'),
	'pt-PT' => array('crowdin_code' => 'pt-PT', 'prestashop_code' => 'pt'), 'ro-RO' => array('crowdin_code' => 'ro', 'prestashop_code' => 'ro'), 'ru-RU' => array('crowdin_code' => 'ru', 'prestashop_code' => 'ru'),
	'si-LK' => array('crowdin_code' => 'si-LK', 'prestashop_code' => 'sh'), 'sl-SI' => array('crowdin_code' => 'sl', 'prestashop_code' => 'si'), 'sk-SK' => array('crowdin_code' => 'sk', 'prestashop_code' => 'sk'),
	'sq-AL' => array('crowdin_code' => 'sq', 'prestashop_code' => 'sq'), 'sr-CS' => array('crowdin_code' => 'sr-CS', 'prestashop_code' => 'sr'), 'sv-SE' => array('crowdin_code' => 'sv-SE', 'prestashop_code' => 'sv'),
	'sw-KE' => array('crowdin_code' => 'sw', 'prestashop_code' => 'sw'), 'ta-IN' => array('crowdin_code' => 'ta', 'prestashop_code' => 'ta'), 'te-IN' => array('crowdin_code' => 'te', 'prestashop_code' => 'te'),
	...
	'nn-NO' => array('crowdin_code' => 'nn-NO', 'prestashop_code' => 'nn')
);
